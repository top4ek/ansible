# Generated by Powerlevel10k configuration wizard on 2023-05-13 at 13:41 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND={{ 251 if temu_light_theme else 238 }}
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND={{ 0 if temu_light_theme else 255 }}
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND={{ 238 if temu_light_theme else 103 }}
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND={{ 12 if temu_light_theme else 39 }
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND={{ 16 if temu_light_theme else 76 }}
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND={{ 16 if temu_light_theme else 76 }}
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND={{ 34 if temu_light_theme else 70 }}
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND={{ 236 if temu_light_theme else 248 }}
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND={{ 16 if temu_light_theme else 180 }}
